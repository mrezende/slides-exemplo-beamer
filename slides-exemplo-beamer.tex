...
% Título
% ---------------------------------------------------------------------------- %
\title{\textbf{slides de exemplo com Beamer}}

\author[Jesús P. Mena-Chalco]{\scriptsize
    Jesús P. Mena-Chalco\\
...
\date{{\tiny 30 de Setembro de 2011}}
...
\begin{frame} 
\frametitle{\textbf{Outro cabeçalho...}}
	\hspace*{-0.6cm}
...
% ---------------------------------------------------------------------------- %
\section{Algumas considerações importantes...}
% ---------------------------------------------------------------------------- %
